...
export function productCostBreakdown(ingredientCost, inventoryCost, directLaborCost) { const ingredients = roundMoney(ingredientCost); const inventory = roundMoney(inventoryCost); const labor = roundMoney(directLaborCost); const materialCost = roundMoney(ingredients + inventory); return { ingredientCost: ingredients, inventoryCost: inventory, materialCost, directLaborCost: labor, total: roundMoney(materialCost + labor) }; }
